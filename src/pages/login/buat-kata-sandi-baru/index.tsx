...
export default function Home() {
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    ...
    //   setValidate(true);
    //   console.log(data);
    //   console.log("Konfirmasi Gagal");
    // } else {
    //   setValidate(false);
    //   console.log(data);
    //   console.log("Konfirmasi Sukses");
    //   router.replace("/login/admin");
    //   alert("Password berhasil disimpan, silahkan kembali ke halaman login");
    // }
    try {
      data.email = "string@gmail.com";
      data.otp = "a7p2bk";
      const response = await axiosInstance.post("/auth/admin/create-new-password", data);
  ...
  //     setValidate("Konfirmasi kata sandi tidak sesuai!");
  //   }
  // };
  ...
  return (
    <div>
      <Head>
        <title>Buat Katasandi Baru</title>
        <meta charSet="utf-8" />
          ...
          <div className="w-2/3">
            <form action="" onSubmit={handleSubmit(onSubmit)}>
              ...
              <p className="font-thin text-center mb-2">
                Minimal menggunakan 8 karakter huruf
              </p>
